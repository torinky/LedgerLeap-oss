...
- [Doc Publication Packet Playbook](./doc-publication-packet-playbook.md): #226 / #227 / #228 を前提に inventory refresh / packet rewrite / comment sync を bounded task で進める手順
