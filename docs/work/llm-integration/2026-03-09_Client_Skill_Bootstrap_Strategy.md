...
**ステータス:** Sprint 1 完了 / Sprint 2 以降は未着手  
...
> **現状メモ:** Sprint 1（情報設計のリセット）は 2026-03-10 に完了。親計画・README・索引の主語を `MCP / API first` へ更新済みです。Sprint 2〜6 は引き続き Issue #83 配下の候補で、**まだ着手しません。**
...
- **Sprint 1 は Issue #83 上で完了管理し、Sprint 2 以降の個別 Issue はまだ起票・着手しない。**
- Sprint 2〜6 は Issue #83 配下の候補であり、着手判断は別途行う。
