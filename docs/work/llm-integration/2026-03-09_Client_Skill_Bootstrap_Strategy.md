...
**ステータス:** Sprint 1-5 完了 / Sprint 6 が未着手
...
- **Sprint 1-5 は完了管理済み**。
- 残タスクは Sprint 6 の bootstrap discovery contract と、その実装前提の capability manifest 整合である。
