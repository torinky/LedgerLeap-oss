...
- **[システム管理者からの通知の編集権限 要件検討メモ](./admin-announcement-banner/2026-04-29_admin_announcement_edit_permission_requirements.md)** 📝 検討中: 閲覧は共通、変更系のみ権限化する前提で、なぜそうしたかの判断理由まで追える形で通知作成担当ユーザーと Seeder のロール割当を整理した要件メモ。
