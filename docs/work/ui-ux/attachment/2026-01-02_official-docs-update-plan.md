...
| 2 | `docs/architecture/vlm-ocr-technology-selection.md` | 部分更新 | 🔴 高 | 1.5-2h | 技術選定理由とアーキテクチャ | 📋 計画中 |
| 3 | `docs/architecture/QueueProcessing.md` | 部分更新 | 🔴 高 | 1-1.5h | 非同期処理の設計思想 | 📋 計画中 |
