...
- [台帳定義ヘッダーにスコア統計表示](./2025-10-12_step1-7-header-score-display.md) - 追加実装
- [検索時の台帳定義スコア順ソート](./2025-10-12_step1-7-ledger-define-sort.md) - 追加実装
- [トラブルシューティングガイド](./2025-10-12_step1-7-troubleshooting.md) - 問題対応
