...
1. Identify the source file and the target public file.
...
6. Remove internal references, temporary notes, and historical discussion.
7. Validate links, headings, and any rendered output that could break navigation.
