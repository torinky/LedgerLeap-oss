                    ...
                    <table class="table table-sm w-full table-fixed">
                        ...
                        <tbody class="divide-y divide-base-100">
                            @foreach ($group['columns'] as $column)
                                ...
                                @else
                                    <tr class="hover:bg-base-200/10 transition-colors {{ $showChanges && $column['status'] !== 'unchanged' ? 'bg-warning/5' : '' }}"
                                            ...
                                            <div class="flex flex-col gap-1.5">
                                                <div class="flex items-start gap-2">
                                                    @if ($column['is_required'])
                                                        <x-mary-icon name="o-check-badge" class="w-3.5 h-3.5 text-error mt-0.5 shrink-0" />
                                                    @endif
                                                    <span
