                ...
                @foreach($columns as $index => $column)
                    <li wire:sortable.item="{{ $column['id'] }}" wire:key="column-{{ $column['id'] }}" class="">
                        <div wire:sortable.handle
                            ...
                            <button class="btn btn-sm tooltip tooltip-left"
                                    data-tip="{{__('ledger.column.drag2sort')}}">
                                <i class="fa-solid fa-grip-lines"></i>
                            </button>
                        </div>
                        <div class="collapse rounded-none bg-base-200 text-primary-content">
                            <input type="checkbox" name="collapse_{{$column['id']}}" id="collapse_{{$column['id']}}"
                                ...
                                <div class="items-center flex flex-row space-x-10">
                                    <div class="basis-1/2 space-y-4">
                                        <x-mary-input label="{{__('ledger.column.title')}}"
                                                      placeholder="{{__('ledger.column.title')}}" icon="o-table-cells"
                                        ...
                                        @endphp
                                        <x-mary-select label="{{__('ledger.column.type')}}" icon="o-chevron-up-down"
                                    ...
                                    <div class="basis-1/2 space-y-4 m-3">
                                        <x-mary-textarea label="{{__('ledger.column.hint')}}"
                                                         ...
                                                         class="input-accent w-full" wire:key="hint-{{$column['id']}}"/>
