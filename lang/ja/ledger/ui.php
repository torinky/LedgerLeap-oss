...
return [
    ...
    'admin' => '管理',
    'admin_email' => '管理者のメール',
    'admin_announcement_banner_title' => '管理者お知らせ',
    ...
    'admin_announcement_banner_list_empty' => '表示できる管理者お知らせはありません。',
    ...
    'admin_announcement_banner_page_title' => '管理者お知らせ',
    'admin_announcement_banner_preview_hint' => '右側のプレビューは、入力内容の見え方を確認するためのものです。',
    'admin_announcement_banner_preview_reset' => 'プレビューをリセット',
    'admin_announcement_banner_preview_summary' => '公開レベル・対象範囲・表示期間と CTA の見え方を、この画面で先に確認できます。',
