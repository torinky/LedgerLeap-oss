...
return [
    ...
    'validation' => [
        'failed' => '修正が必要です',
        'summary_title' => '入力内容に :count 件のエラーがあります',
        'summary_hint' => '各項目をクリックすると該当箇所へ移動できます',
        'show_summary' => 'エラー内容を表示',
        'hide_summary' => 'エラー内容を非表示',
        'required_errors' => '必須項目の不足',
        'format_errors' => '入力内容の不備',
        'required_keywords' => ['必須', '入力してください', '選択してください', 'required'],
    ],
    'version' => 'バージョン',
    'view' => 'ビュー',
