...
return [
    ...
    'mcp' => [
        ...
        'workflow_history_comparison_summary' => 'Ver.:target_version から Ver.:base_version への変更を比較しました。'
            .'変更項目は :count 件で、更新者は :modifier、更新日時は :datetime です。',
    ...
    'related' => [
        ...
        'identifier_key_with_source' => ':value（:source）',
        'identifier_source_auto_number' => '識別番号列',
        'identifier_source_text_column' => 'テキスト記載',
        'identifier_tooltip' => '識別番号: :keys',
        'identifier_unavailable_tooltip' => '識別番号カラムがありません',
        'rag_unavailable_tooltip' => '意味検索は現在利用できません',
        'reason_both' => '両方',
        'reason_column_label' => '関連理由',
