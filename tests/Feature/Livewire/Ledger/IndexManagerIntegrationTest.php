...
class IndexManagerIntegrationTest extends TestCase
{
    ...
    #[Test]
    public function it_updates_active_ledger_define_confidentiality(): void
    {
        ...
        $component = Livewire::test(IndexManager::class)
            ->set('currentFolderId', $this->subFolder->id);

        // 初期状態は currentFolder の秘密区分
        $component->assertSet('activeLedgerDefineId', null);
