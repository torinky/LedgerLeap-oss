...
class WorkflowServiceTest extends TestCase
{
    ...
    public function test_can_request_approval_returns_true_when_all_conditions_are_met(): void
    {
    ...
    public function test_can_request_approval_returns_false_when_cannot_proceed(): void
    {
    ...
    public function test_can_request_approval_returns_false_when_user_is_not_inspector(): void
    {
        $ledger = $this->partialMockLedger(true, null);
        $ledger->status = WorkflowStatus::PENDING_INSPECTION;
    ...
    public function test_can_request_approval_returns_false_when_status_is_not_pending_inspection(): void
    {
        $ledger = $this->partialMockLedger(true, null);
    ...
    public function test_can_approve_returns_true_when_user_is_approver_and_status_is_pending(): void
    {
    ...
    public function test_can_approve_returns_true_when_it_can_be_finally_approved(): void
    {
    ...
    public function test_can_approve_returns_false_when_all_conditions_are_false(): void
    {
        $ledger = $this->partialMockLedger(null, false);
        $ledger->status = WorkflowStatus::PENDING_APPROVAL;
        $ledger->latestDiff = LedgerDiff::factory()->make(['approver_id' => User::factory()->create()->id, 'ledger_define_id' => $this->ledgerDefine->id]);
    ...
    public function test_can_approve_returns_false_when_status_is_draft(): void
    {
        $ledger = $this->partialMockLedger(null, true);
        $ledger->status = WorkflowStatus::DRAFT;
    ...
    public function test_can_return_to_draft_returns_true_when_user_is_inspector_in_pending_inspection(): void
    {
    ...
    public function test_can_return_to_draft_returns_true_when_user_is_approver_in_pending_approval(): void
    {
    ...
    public function test_can_return_to_draft_returns_false_when_user_is_not_the_assignee(): void
    {
        $ledger = Ledger::factory()->make(['status' => WorkflowStatus::PENDING_APPROVAL, 'ledger_define_id' => $this->ledgerDefine->id]);
        $ledger->latestDiff = LedgerDiff::factory()->make(['approver_id' => User::factory()->create()->id, 'ledger_define_id' => $this->ledgerDefine->id]);
    ...
    public function test_can_return_to_draft_returns_false_when_status_is_not_pending(): void
    {
