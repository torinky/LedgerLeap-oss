...
class AsColumnDefinesArrayJsonTest extends TestCase
{
    ...
    public function it_can_cast_to_array_object_and_back()
    {
        // テストに使用するデータを定義します。
        $data = [
            ['id' => 123, 'name' => 'Column1', 'type' => 'number', 'order' => 0, 'required' => 0, 'doNotDuplicate' => 1, 'sortBy' => 1],
            ['id' => 124, 'name' => 'Column2', 'type' => 'text', 'order' => 1, 'required' => 1, 'doNotDuplicate' => 0, 'sortBy' => 0],
        ];
