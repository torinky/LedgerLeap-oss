        ...
        $ledgers = [
            ...
            [
                'content' => [
                    ...
                    3 => '提案中',                         // 商談ステータス
                    4 => '高',                             // 優先度
                    5 => "本日、株式会社A商事の購買部長である鈴木様と田中様にお会いし、当社の新製品「LedgerLeap」についてご紹介させていただきました。\n\n鈴木様からは、現在使用している台帳管理システムが古く、検索機能が弱いことが課題とのお話がありました。特に、過去の記録を探すのに時間がかかり、業務効率が落ちているとのことです。\n\nLedgerLeapの全文検索機能、特にMroongaを使った高速検索をデモでお見せしたところ、非常に興味を持っていただけました。また、ワークフロー機能による承認プロセスの自動化についても、「これはまさに求めていた機能だ」とおっしゃっていただけました。", // 商談内容
                    6 => "非常に好感触でした。特に検索機能とワークフローに強い関心を示されていました。価格面での調整が必要になりそうですが、導入の可能性は高いと感じています。", // 成果・所感
                    7 => "来週、詳細な見積もりと導入スケジュールの提案書を持参します。また、実際のデータを使ったPOC環境の準備も進めます。", // 次回アクション
                ],
            ...
            [
                'content' => [
                    ...
                    3 => 'フォローアップ',
                    4 => '高',
                    5 => "昨日の提案を受けて、鈴木部長から追加のご質問をいただきました。\n\n主な質問内容:\n1. 既存システムからのデータ移行方法と期間\n2. セキュリティ対策（特にアクセス制御）\n3. バックアップとディザスタリカバリの仕組み\n4. カスタマイズの可能性と費用\n\n特にデータ移行については、現在3万件以上の台帳データがあり、これを確実に移行できるかが最大の関心事とのことでした。当社の実績として、B社での5万件のデータ移行事例をご紹介し、安心していただけたようです。",
                    6 => "技術的な質問が多く出たことは、導入に向けて真剣に検討されている証拠だと感じました。来週の提案書では、移行計画を重点的に説明する必要があります。",
                    7 => "データ移行計画書を作成し、来週の訪問時に提示します。また、POC環境でA商事様の実データサンプルを使ったデモができるよう準備します。",
                ],
