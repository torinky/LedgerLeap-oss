    ...
    public static function getMockFiles(): array
    {
        ...
        return [
            ...
            [
                ...
                'mime' => 'application/pdf',
                'status' => 'error',
                'finalized_at' => now()->subHours(1),
                'thumbnailUrl' => null,
                'downloadUrl' => '#',
                'primary_download' => ['url' => '#', 'label' => 'Download', 'icon' => 'fa-download'],
                'mock_vlm_text' => null,
                'mock_ocr_text' => null,
                'mock_tika_text' => null,
                ...
                'updated_at' => now()->subHours(1),
                'vlm_processed_at' => now()->subHours(1),
                'ocr_processed_at' => now()->subHours(1),
                'tika_processed_at' => now()->subHours(1),
                'processing_finalized_at' => now()->subHours(1),
                'mock_creator_name' => '鈴木一郎',
                'mock_folder_path' => 'テスト / エラー',
            ],
            ...
            [
                ...
                'mock_vlm_text' => null,
                'mock_ocr_text' => null,
                'mock_tika_text' => 'Some basic text extracted...',
                'mock_vlm_status' => 'missing',
                'mock_ocr_status' => 'timeout',
                'mock_tika_status' => 'completed',
                'mock_preview_text' => 'Some basic text extracted...',
                'mock_confidence' => null,
                'mock_source' => 'Tika',
                ...
                'tika_processed_at' => now()->subHours(23),
                'mock_creator_name' => '高橋次郎',
                'mock_folder_path' => 'テスト / 大容量',
            ],

            // Tika単独失敗ファイル（VLM/OCR成功）
            [
                'id' => 10017,
                'column_id' => $mockColumnId,
                'filename' => '特殊フォーマット.pdf',
                'mime' => 'application/pdf',
                'status' => 'completed',
                ...
                'downloadUrl' => '#',
                'primary_download' => ['url' => '#', 'label' => 'Download', 'icon' => 'fa-download'],
                'mock_vlm_text' => "VLMで解析できました。\n\n文書の内容は正常に抽出されています。",
                'mock_ocr_text' => "OCR処理も成功しています。\n\nテキストは認識されました。",
                'mock_tika_text' => null,
                'mock_vlm_status' => 'completed',
                'mock_ocr_status' => 'completed',
                'mock_tika_status' => 'error',
                'mock_preview_text' => 'VLMで解析できました。文書の内容は正常に抽出されています。',
                'mock_confidence' => 0.92,
                'mock_source' => 'VLM',
                'size' => 1024 * 800, // 800KB
                'created_at' => now()->subHours(3),
                ...
                'ocr_processed_at' => now()->subHours(2),
                'tika_processed_at' => now()->subHours(2),
                'processing_finalized_at' => now()->subHours(2),
                'mock_creator_name' => '伊藤美咲',
                'mock_folder_path' => 'テスト / 特殊形式',
            ],
            ...
            [
                ...
                'mock_tika_text' => null,
                'mock_vlm_status' => 'missing',
                'mock_ocr_status' => 'missing',
                'mock_tika_status' => 'missing',
                'mock_preview_text' => null,
                'mock_confidence' => null,
                'mock_source' => null,
                'original_mime_type' => 'application/zip',
                ...
                'processing_finalized_at' => now()->subMinutes(30),
                'mock_creator_name' => '渡辺健太',
                'mock_folder_path' => 'テスト / アーカイブ',
            ],
        ];
    }
