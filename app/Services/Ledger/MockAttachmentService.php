    ...
    public static function getMockFiles(): array
    {
        ...
        return [
            ...
            [
                ...
                'thumbnailUrl' => 'https://via.placeholder.com/150x150/FFA500/FFFFFF?text=PDF',
                'downloadUrl' => '#',
                'primary_download' => ['url' => '#', 'label' => 'Download PDF', 'icon' => 'fa-download'],
                'mock_vlm_text' => "処理完了済みのドキュメントです。\n\n内容は正常に抽出されています。",
                'mock_ocr_text' => "OCR処理も完了しています。テキストが正常に認識されました。",
                'mock_tika_text' => "Tika processing completed successfully.",
                'mock_vlm_status' => 'completed',
                'mock_ocr_status' => 'completed',
                'mock_tika_status' => 'completed',
                'mock_preview_text' => "処理完了済みのドキュメントです。内容は正常に抽出されています。",
                'mock_confidence' => 0.95,
                'mock_source' => 'VLM',
                'vlm_processing_time_ms' => 2500,
                'ocr_processing_time_ms' => 1800,
                'tika_processing_time_ms' => 500,
                'created_at' => now()->subHours(2),
                'updated_at' => now()->subHours(1),
                'vlm_processed_at' => now()->subHours(1),
                'ocr_processed_at' => now()->subMinutes(90),
                'tika_processed_at' => now()->subMinutes(85),
                'mock_creator_name' => '山田太郎',
                'mock_folder_path' => 'テスト / 未最終化',
            ],
            ...
            [
                ...
                'status' => 'processing',
                'finalized_at' => null, // 未最終化
                'thumbnailUrl' => 'https://via.placeholder.com/150x150/FF9800/FFFFFF?text=JPG',
                'downloadUrl' => '#',
                'primary_download' => ['url' => '#', 'label' => 'Download Image', 'icon' => 'fa-download'],
                'secondary_download' => ['url' => '#pdf', 'label' => 'PDF', 'icon' => 'fa-file-pdf'],
                'mock_vlm_text' => "VLM処理は完了しています。",
                'mock_ocr_text' => null, // OCR処理中
                'mock_tika_text' => "Tika processing completed.",
                'mock_vlm_status' => 'completed',
                'mock_ocr_status' => 'processing',
                'mock_tika_status' => 'completed',
                'mock_preview_text' => "VLM処理は完了しています。",
                'mock_confidence' => 0.88,
                'mock_source' => 'VLM',
                'vlm_processing_time_ms' => 3200,
                'tika_processing_time_ms' => 600,
                'created_at' => now()->subMinutes(30),
                'updated_at' => now()->subMinutes(5),
                'vlm_processed_at' => now()->subMinutes(10),
                'tika_processed_at' => now()->subMinutes(8),
                'mock_creator_name' => '佐藤花子',
                'mock_folder_path' => 'テスト / 未最終化',
            ],
        ];
    }
